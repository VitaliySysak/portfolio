  ...
  return (
    <div
      ...
      <ul
        ...
        {items.map((item) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 p-5 md:p-16 md:w-[60vw] border-zinc-800 bg-gradient-to-r from-[rgba(4,7,29,1)] to-[rgba(12,14,35,1)]"
            key={item.id}>
            <blockquote>
              <div
                aria-hidden="true"
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <div className="me-3">
                    <Image width={50} height={50} src={"/profile.svg"} alt="photo" />
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-sm leading-[1.6] font-normal text-gray-400">{item.name}</span>
                    <span className="text-sm leading-[1.6] font-normaltext-gray-400">{item.title}</span>
                  </div>
                </span>
              </div>
            </blockquote>
